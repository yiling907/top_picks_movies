locals {
  ...
  music_app_cluster_name        = "django-app-cluster"
  availability_zones           = ["ap-southeast-1a", "ap-southeast-1b", "ap-southeast-1c"]
  music_app_task_famliy         = "django-app-task"
  container_port               = 8000
  music_app_task_name           = "django-app-task"
  ...
  music_app_service_name = "django-app-service"
}